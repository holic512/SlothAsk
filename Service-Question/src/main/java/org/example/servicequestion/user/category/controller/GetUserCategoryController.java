...
public class GetUserCategoryController {
    ...
    public ApiResponse getCategoryIdAndName(
        ...
        List<CategoryIdAndNameDto> categories = getUserCategoryService.getCategoryIdAndName(upcId);
    ...
    public ApiResponse getTagIdAndName(
        ...
        return new ApiResponse(200, "获取对应标签成功",
                getUserCategoryService.getTagIdAndName(upcId));
    }
    ...
    public ApiResponse getQuestionList(
        ...
        return new ApiResponse(200, "获取对应问题列表成功",
                getUserCategoryService.getQuestionList(upcId, request));
    }
}
