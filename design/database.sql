...
CREATE TABLE `user_profile` (
  ...
  CONSTRAINT `fk_profile_achievement` FOREIGN KEY (`display_achievement_id`) REFERENCES `user_achievement` (`id`) ON DELETE SET NULL
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='项目大分类表';
...
CREATE TABLE `question_category` (
  ...
  `sort_order` int(11) DEFAULT 0 COMMENT '排序序号',
  `view_count` BIGINT UNSIGNED NOT NULL DEFAULT '0' COMMENT '访问数量',
  `status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '状态 1:正常 0:禁用',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='题库内容表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='题目评论表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='题库分类评论表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='用户刷题统计表';
...
CREATE TABLE `member_level` (
  `id` BIGINT UNSIGNED AUTO_INCREMENT COMMENT '等级ID',
...
CREATE TABLE `user_member` (
  `id` BIGINT UNSIGNED AUTO_INCREMENT COMMENT '用户会员ID',
...
CREATE TABLE `user_points` (
  `id` BIGINT UNSIGNED AUTO_INCREMENT COMMENT '积分记录ID',
  `user_id` BIGINT UNSIGNED NOT NULL COMMENT '用户ID',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='题库权限表';

-- 用户题库权限表（简化后）
CREATE TABLE `user_category_permission` (
  `id` BIGINT UNSIGNED AUTO_INCREMENT COMMENT '用户权限ID',
  `user_id` BIGINT UNSIGNED NOT NULL COMMENT '用户ID',
  `category_id` BIGINT UNSIGNED NOT NULL COMMENT '题库分类ID',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='用户题库权限表';

-- 签到记录表
CREATE TABLE `user_sign_in` (
  `id` BIGINT UNSIGNED AUTO_INCREMENT COMMENT '签到ID',
  `user_id` BIGINT UNSIGNED NOT NULL COMMENT '用户ID',
...
CREATE TABLE `category_rating` (
  `id` BIGINT UNSIGNED AUTO_INCREMENT COMMENT '评分ID',
  `user_id` BIGINT UNSIGNED NOT NULL COMMENT '用户ID',
  `category_id` BIGINT UNSIGNED NOT NULL COMMENT '题库分类ID',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='题库评分表';
...
CREATE TABLE `user_follow` (
  ...
  `followed_user_id` BIGINT UNSIGNED NOT NULL COMMENT '被关注者ID',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
